...
public class CommissionEmployee extends Employee implements Cloneable {
    ...
    @Override
    public double computeSalary(int currentMonth) { return (totalSale * getCommissionRate()) + super.computeSalary(currentMonth); }

    @Override
    public double computeSalary() { return (totalSale * getCommissionRate()) + super.computeSalary(); }
