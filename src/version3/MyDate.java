...
public class MyDate implements Cloneable {
    ...
    public void setDay(int day) {
        if (!isValidDate(day, this.month, this.year)) throw new IllegalArgumentException("Invalid day");
        this.day = day;
    }
    public int getMonth() { return month; }
    public void setMonth(int month) {
        if (!isValidDate(this.day, month, this.year)) throw new IllegalArgumentException("Invalid month");
        this.month = month;
    }
    public int getYear() { return year; }
    public void setYear(int year) {
        if (!isValidDate(this.day, this.month, year)) throw new IllegalArgumentException("Invalid year");
        this.year = year;
    }
